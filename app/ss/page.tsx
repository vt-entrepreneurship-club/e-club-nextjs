  ...
  return (
    ...
    >
      ...
      <div className="lg:grid lg:grid-cols-2">
        <div className="blue-glow mx-auto mt-10 w-[94%] rounded-md border border-purple-600 p-4">
      ...
      <div className="max-w-md mx-auto my-6 p-6 rounded-lg shadow-md">
        ...
        <div className="flex justify-between py-2 border-b border-orange-200">
          <span className="font-semibold">All participants must be VT students</span>
        </div>
        ...
        <div className="flex justify-between py-2 pl-6">
          <span className="text-red-500 font-bold text-ce ">Due 7:00 AM Tuesday morning</span>
        </div>
        <div className="flex justify-between py-2 pl-6">
          <span className="text-white font-bold text-ce">2 Min Demo video of your product</span>
        </div>
        <div className="flex justify-between py-2 pl-6">
          <span className="text-white font-bold text-ce">Slide deck explaining problem, product, business model</span>
        </div>
      </div>
    </div>
        </div>
