...
function NavBar() {
  ...
  return (
    <div className="navbar mx-auto mb-10 w-11/12 p-2 pb-6 flex items-center justify-between">
      <Link href="/">
        <Image className="w-1/3" id="logo" src={logo} alt="" />
      </Link>

      <div className="lg:float-right hidden lg:block">
        <Link className="ml-20 text-xl" href="/">
          Home
        </Link>
